...
#### 関数設定ラベル
CELL_EVAL_CONF_LABEL_TCOORD_X=0E
CELL_EVAL_CONF_LABEL_FUNC_TCOORD_Y=01
CELL_EVAL_CONF_LABEL_CONF_TCOORD_Y=02
#### 評価関数選択外枠
...
#### 関数設定外枠
CELL_EVAL_CONF_FRAME_TCOORD_X=0E
CELL_EVAL_CONF_FRAME_TCOORD_Y=03
CELL_EVAL_CONF_FRAME_WIDTH=06
CELL_EVAL_CONF_FRAME_HEIGHT=0F
#### 関数名
...
f_binbio_place_cell_eval_config() {
	...
	## 関数設定
	con_print_xy_macro $CELL_EVAL_CONF_LABEL_TCOORD_X $CELL_EVAL_CONF_LABEL_FUNC_TCOORD_Y $a_const_func_str
	con_print_xy_macro $CELL_EVAL_CONF_LABEL_TCOORD_X $CELL_EVAL_CONF_LABEL_CONF_TCOORD_Y $a_const_conf_str

...
char_tiles() {
	...
	# 0c: 最小化ボタン
	echo -en '\x00\x00\x3e\x3e\x3e\x3e\x3e\x3e'
	echo -en '\x1c\x1c\x1c\x1c\x08\x08\x00\x00'
	# 0d: 最大化ボタン
	echo -en '\x00\x00\x08\x08\x1c\x1c\x1c\x1c'
	echo -en '\x3e\x3e\x3e\x3e\x3e\x3e\x00\x00'
	...
	echo -en '\x04\x04\x42\x42\x20\x20\x1e\x1e'
	...
	# 細胞
	# 8b: cell
	echo -en '\x0e\x00\x11\x0e\x15\x0e\x2a\x1c'
	echo -en '\x2a\x1c\x54\x38\x44\x38\x38\x00'

	# デイジーワールド
	# 8c: 白デイジー
	echo -en '\x3c\x00\x7e\x00\xe7\x18\xe7\x18'
	echo -en '\x7e\x00\x3c\x00\x00\xdb\x00\x3c'
	# 8d: 黒デイジー

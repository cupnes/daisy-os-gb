...
char_tiles() {
	...
	# デイジーワールド
	# 8c: 白デイジー
	echo -en '\x3c\x00\x7e\x00\xff\x00\xe7\x18'
	echo -en '\xe7\x18\xff\x00\x7e\x00\x3c\x00'
	# 8d: 黒デイジー
	echo -en '\x3c\x3c\x7e\x7e\xff\xff\xe7\xff'
	echo -en '\xe7\xff\xff\xff\x7e\x7e\x3c\x3c'
}

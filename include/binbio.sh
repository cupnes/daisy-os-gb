...
# 実験セット番号
BINBIO_EXPSET_DAISY=00	# アルファベットタイルの中から"DAISY"を形成
BINBIO_EXPSET_HELLOWORLD=01	# 全タイルの中から"こんにちは、せかい!"を形成

# 初期値
## システム変数
BINBIO_MUTATION_PROBABILITY_INIT=4d	# 突然変異の発生しやすさ
BINBIO_EXPSET_NUM_INIT=$BINBIO_EXPSET_HELLOWORLD	# 現在の実験セット番号
## 初期細胞
